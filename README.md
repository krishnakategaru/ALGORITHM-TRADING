...
- train different sentimental models using ohlc data
...
│   └── sentiment_analysis_2_model.py
│   └── sentiment_analysis_transformer_model.py
│   └── sentiment_analysis_gru_model.py
├── strategies/
